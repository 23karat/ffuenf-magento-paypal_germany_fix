...
class Mage_Core_Model_Store extends Mage_Core_Model_Abstract
{
    ...
    {
				// ffuenf
				// round prices to 4 instead of 2 decimals
				// this breaks current interaction with paypal, since amounts are not transfered incl. tax so that paypal summs up differently and detects a fraud payment
